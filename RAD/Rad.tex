...
\begin{itemize}
    ...
    \item \textbf{Schermata di Ricerca e Consultazione Profilo:} Interfaccia dedicata agli utenti della piattaforma e ai valutatori esterni. Permette di cercare uno studente per nome e cognome per consultarne il profilo pubblico e tramite l'inserimento di un codice valido, permette di visualizzare i file privati.
...
\subsubsection{Funzionalità per lo Studente}
...
\subsubsection{Funzionalità per l'Utente Esterno}
...
Flusso degli eventi &
\begin{enumerate}
    \item Lo studente seleziona il file di interesse e clicca il tasto "opzioni".
    \item Il Sistema mostra a schermo una schermata contenente "Modifica file", "Privacy", "Elimina file".
...
Si premette che le interfacce riportate di seguito rappresentano schermate significative del Sistema allo stato attuale di implementazione. Le schermate sono state ricavate dall'applicazione JavaFX e possono presentare variazioni grafiche minori rispetto a eventuali versioni successive del prodotto.

\newcommand{\radinterfacefigure}[2]{
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\textwidth,height=0.29\textheight,keepaspectratio]{#1}
    \caption{#2}
\end{figure}
\vspace{-0.25cm}
}
...
\radinterfacefigure{pdf/INTERFACCE/01-schermata-principale.png}{Interfaccia - Schermata Principale}

\paragraph{Login}
\radinterfacefigure{pdf/INTERFACCE/02-login.png}{Interfaccia - Login}
\newpage

\paragraph{Registrazione}
\radinterfacefigure{pdf/INTERFACCE/03-registrazione.png}{Interfaccia - Registrazione}

\paragraph{Recupera Password}
\radinterfacefigure{pdf/INTERFACCE/04-recupera-password.png}{Interfaccia - Recupera Password}
\newpage

\paragraph{Verifica Identita}
\radinterfacefigure{pdf/INTERFACCE/05-verifica-identita.png}{Interfaccia - Verifica Identita}

\paragraph{Home AFAM}
\radinterfacefigure{pdf/INTERFACCE/06-home-afam.png}{Interfaccia - Home AFAM}
\newpage

\paragraph{Gestione Profilo}
\radinterfacefigure{pdf/INTERFACCE/07-gestione-profilo.png}{Interfaccia - Gestione Profilo}

\paragraph{Dati Personali}
\radinterfacefigure{pdf/INTERFACCE/08-dati-personali.png}{Interfaccia - Dati Personali}
\newpage

\paragraph{Background Artistico}
\radinterfacefigure{pdf/INTERFACCE/09-background-artistico.png}{Interfaccia - Background Artistico}

\paragraph{Form Background Artistico}
\radinterfacefigure{pdf/INTERFACCE/10-form-background-artistico.png}{Interfaccia - Form Background Artistico}
\newpage

\paragraph{Gestione Contenuti}
\radinterfacefigure{pdf/INTERFACCE/11-gestione-contenuti.png}{Interfaccia - Gestione Contenuti}

\paragraph{Seleziona Tipologia File}
\radinterfacefigure{pdf/INTERFACCE/12-tipologia-file.png}{Interfaccia - Selezione Tipologia File}
\newpage

\paragraph{Elenco File}
\radinterfacefigure{pdf/INTERFACCE/13-elenco-file.png}{Interfaccia - Elenco File}

\paragraph{Upload File}
\radinterfacefigure{pdf/INTERFACCE/14-upload-file.png}{Interfaccia - Upload File}
\newpage

\paragraph{Gestione Condivisione con Link}
\radinterfacefigure{pdf/INTERFACCE/15-gestione-condivisione-link.png}{Interfaccia - Gestione Condivisione con Link}

\paragraph{Seleziona Contenuti per Link}
\radinterfacefigure{pdf/INTERFACCE/16-seleziona-contenuti-link.png}{Interfaccia - Selezione Contenuti per Link}
\newpage

\paragraph{Generazione Link}
\radinterfacefigure{pdf/INTERFACCE/17-generazione-link.png}{Interfaccia - Generazione Link}

\paragraph{Elenco Link}
\radinterfacefigure{pdf/INTERFACCE/18-elenco-link.png}{Interfaccia - Elenco Link}
\newpage

\paragraph{Gestione Condivisione Interna}
\radinterfacefigure{pdf/INTERFACCE/19-gestione-condivisione-interna.png}{Interfaccia - Gestione Condivisione Interna}

\paragraph{Seleziona Contenuti Privati}
\radinterfacefigure{pdf/INTERFACCE/20-seleziona-contenuti-privati.png}{Interfaccia - Selezione Contenuti Privati}
\newpage

\paragraph{Generazione Codice}
\radinterfacefigure{pdf/INTERFACCE/21-generazione-codice.png}{Interfaccia - Generazione Codice}

\paragraph{Elenco Codici}
\radinterfacefigure{pdf/INTERFACCE/22-elenco-codici.png}{Interfaccia - Elenco Codici}
\newpage

\paragraph{Ricerca Studente}
\radinterfacefigure{pdf/INTERFACCE/23-ricerca.png}{Interfaccia - Ricerca Studente}

\paragraph{Risultato Ricerca}
\radinterfacefigure{pdf/INTERFACCE/24-risultato-ricerca.png}{Interfaccia - Risultato Ricerca}
\newpage

\paragraph{Profilo Studente}
\radinterfacefigure{pdf/INTERFACCE/25-profilo-studente.png}{Interfaccia - Profilo Studente}



\paragraph{Contenuti Condivisi tramite Link}
\radinterfacefigure{pdf/INTERFACCE/27-contenuti-condivisi-link.png}{Interfaccia - Contenuti Condivisi tramite Link}
