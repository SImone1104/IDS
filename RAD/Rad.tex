...
Flusso degli eventi &
\begin{enumerate}[topsep=0.2em,itemsep=0.15em,parsep=0pt,partopsep=0pt]
    \item Lo studente clicca sul pulsante ``Gestione Portfolio''.
    \item Il Sistema mostra a video la schermata ``Gestione Portfolio''.
...
\begin{enumerate}
    ...
    \item Il Sistema mostra a video la schermata ``Modifica Privacy'' contenente le opzioni di visualizzazione del file (Pubblico, Privato, Non in elenco) e il pulsante ``Conferma Modifica''.
...
ID & 4.4 \\ \hline
Attori & Studente (iniziatore), DBMS (partecipante) \\ \hline
Precondizioni & Il Sistema ha mostrato a video la schermata ``Elenco File''. \\ \hline
Flusso degli eventi &
\begin{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{pdf/sequence/GESTIONE CONDIVISIONE LINK/VisualizzaElencoCodici.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{pdf/sequence/GESTIONE CONDIVISIONE LINK/Verifica validità link.pdf}
...
\newpage
\paragraph{Visualizza Contenuto Tramite Link - Visualizza Contenuto Tramite Link}
\begin{figure}[H]
    \centering
    ...
    \caption{Diagramma di sequenza - Visualizza Contenuto Tramite Link - Visualizza Contenuto Tramite Link}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Diagramma delle classi - Visualizza Contenuto Tramite Link - Visualizza Contenuto Tramite Link}
\end{figure}
