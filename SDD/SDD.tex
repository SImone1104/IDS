...
Il sistema viene organizzato in sottosistemi applicativi specializzati, ciascuno responsabile di un gruppo coerente di funzionalita': Gestione Studente, Gestione Autenticazione, Gestione Condivisione, Consultazione e Gestione Operazioni Automatiche. La boundary DBMS rappresenta il punto di accesso ai dati persistenti e fornisce alle componenti di controllo i metodi necessari per recuperare, salvare e aggiornare gli oggetti di dominio.
...
\begin{itemize}
    ...
    \item \textbf{Consultazione:} consente la consultazione dei profili e dei contenuti autorizzati. Include la ricerca dello studente, la visualizzazione del profilo, la consultazione dei contenuti pubblici, lo sblocco dei contenuti privati tramite codice e la visualizzazione dei contenuti condivisi tramite link.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{pdf/asta/mappaturaHardwareSoftware.pdf}
    \caption{Mappatura hardware e software del sistema AFAM Connect}
    \label{fig:mappatura_hardware_software}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{pdf/asta/modelloER.pdf}
    \caption{Modello E-R del database AFAM Connect}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.66\textheight,keepaspectratio]{pdf/asta/modelloRelazionale.pdf}
    \caption{Modello relazionale del database AFAM Connect}
    \label{fig:modello_relazionale}
\end{figure}
...
telefono & VARCHAR(10) & NOT NULL & Numero di telefono dello studente. \\ \hline
percorso\_foto & VARCHAR(255) & NULL & Percorso del file della foto profilo. \\ \hline
...
scuola\_universita & VARCHAR(255) & NULL & Istituto frequentato. \\ \hline
collaborazioni\_\allowbreak fatte & TEXT & NULL & Collaborazioni artistiche. \\ \hline
collaborazioni\_\allowbreak autori & TEXT & NULL & Autori o riferimenti. \\ \hline
...
tipologia & VARCHAR(30) & NOT NULL & Categoria tecnica usata per la navigazione e il filtro dei contenuti (audio, video, immagine, documento). \\ \hline
formato & VARCHAR(20) & NOT NULL & Formato specifico o estensione del file (ad esempio MP3, MP4, PNG, PDF). \\ \hline
dimensione & INT & NOT NULL & Dimensione in byte. \\ \hline
stato\_privacy & ENUM & NOT NULL & Pubblico, privato o non in elenco. \\ \hline
...
La tabella rappresenta l'associazione molti-a-molti tra link di condivisione e file selezionati: uno stesso link puo' essere associato a piu' file, e uno stesso file puo' comparire in piu' link diversi.
...
\multicolumn{1}{c|}{\textbf{Descrizione}} \\
\hline
id\_link & INT & PK, FK, NOT NULL & Link che raggruppa uno o piu' file selezionati. \\ \hline
id\_file & INT & PK, FK, NOT NULL & File incluso tra i contenuti resi disponibili dal link. \\ \hline
...
\multicolumn{1}{c|}{\textbf{Descrizione}} \\
\hline
id\_codice & INT & PK, FK, NOT NULL & Codice che raggruppa uno o piu' file privati selezionati. \\ \hline
id\_file & INT & PK, FK, NOT NULL & File privato reso consultabile tramite il codice. \\ \hline
